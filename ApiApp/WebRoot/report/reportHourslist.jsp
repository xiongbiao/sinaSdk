...
<body>
	...
	<div id="main">
		<div id="" class="main-title">按时报表</div>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			t = $('#mytb').grid({
				...
				msg : '数据加载中 请稍后…………',
				size : 10,
				url : '${ctx}/report/hourlyReport',
				colModel : [ {
					"dataflie" : "timeStr",
					"headfile" : "时间",
					"width" : 50
				}, {
					"dataflie" : "totaluid_cnt",
					"headfile" : "总用户量",
					"width" : 70
				}, {
					"dataflie" : "reguid_cnt",
					...
					"dataflie" : "load_cnt_update",
					"headfile" : "(新增)发送次数",
					"width" : 80
				}, {
					"dataflie" : "show_cnt_update",
					"headfile" : "(新增)展示次数",
					"width" : 80
				}, {
					"dataflie" : "rate",
