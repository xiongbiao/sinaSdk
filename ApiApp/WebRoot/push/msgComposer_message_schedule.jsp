		  ...
		  function isShow(){
		   ...
		   $(function(){
		    $('#drafts-form').ajaxForm({  
		      ...
		      //加载消息列表pageIndex	1
		     jQuery.post("${ctx}/pushMsg/getPushList",{"pageIndex": 1,"msgType":0,"appId":<%=appId %>,"isScheduled": true},  function(data) {
			     var str="";
			     for(var i=0;i<data.rows.length;i++){
			        str = str+ '   <tr>' +
							   '     <td><input type="checkbox" value="'+data.rows[i].msgId+'" onclick="isShow()" name="cbox"></td>' +
