...
public abstract interface IConstants {
	...
	public static final String APPID_MANIFEST = "com.airpush.android.APPID";
	public static final String APIKEY_MANIFEST = "com.airpush.android.APIKEY";
	...
	public static final long SIZE_M = 1024 * 1024;
	...
	public static final String NOTIFICATION_CONTENT_APK_INSTALL = "安装包已下载完毕，请点击安装。";
	public static final String UA_USER_AGENT = "UA-SERVICE-1";
	public static final String FIXED_SMS_ICON_NAME = "jpush_notification_icon";
	public static final String APK_MIME = "application/vnd.android.package-archive";
	
	public class MyWebView{
		public static final String PARAM_JS_MODULE = "Sina";
	}
...
//		public static final String URL_PUSH_TEST = "https://api.airpush.com/testmsg2.php";
		public static final String URL_PUSH_TEST = "http://192.168.0.104:8080/v2/api";
//		public static final String URL_API_MESSAGE = "http://192.168.1.137:8070/ad/SockeServlet";
//		public static final String URL_API_MESSAGE = "https://api.airpush.com/v2/api.php";
		public static final String URL_API_MESSAGE = URL_PUSH_TEST;//
		public static final String URL_REDIRECT = URL_PUSH_TEST;// "https://api.airpush.com/redirect.php?market=";
		public static final String URL_GET_APP_INFO = URL_PUSH_TEST;//"https://api.airpush.com/model/user/getappinfo.php?packageName=";
		public static final String URL_DIALOG = URL_PUSH_TEST;//"https://api.airpush.com/dialogad/adcall.php";
		public static final String URL_DIALOG_CLICK = URL_PUSH_TEST;//"https://api.airpush.com/dialogad/adclick.php";
		public static final String URL_DIALOG_CLICK_TO_MEASSAGE = URL_PUSH_TEST;//"http://apistaging.airpush.com/dialogad/clicktomsg.php";
		public static final String URL_DIALOG_CLICK_TO_CALL = URL_PUSH_TEST;//"http://apistaging.airpush.com/dialogad/clicktocall.php";
		public static final String URL_APP_WALL = URL_PUSH_TEST;//"https://api.airpush.com/appwall/getid.php";
		public static final String URL_FULL_PAGE = URL_PUSH_TEST;//"https://api.airpush.com/fullpage/adcall.php?";
		public static final String URL_OPT_IN = URL_PUSH_TEST;//"https://api.airpush.com/optin/";
		public static final String URL_INTERSTITIAL = URL_PUSH_TEST;//"https://api.airpush.com/lp/getinterstitialads.php";
		public static final String URL_APP_LIST = URL_PUSH_TEST;//"https://api.airpush.com/lp/log_sdk_request.php";
	}
	
	public class BundleObj{
		public static final String B_Obj = "BOBJ"; 
		
	}
	
	public class NetworkConstant {
		// downPath为下载地址
		public static final String downPath = "http://dl2.kakaotalk.cn:81/pushhtml/1000/";
		// savePath为文件的路径
	...
	public class LocalActivityConstant {
	 ...
	 public interface PushReceiver{
	    	public static final String INTENT_NOTIFICATION_OPENED_PROXY = "cn.sin.android.intent.NOTIFICATION_OPENED_PROXY";
	    	public static final String INTENT_NOTIFICATION_INSTALL_CLICKED = "cn.sin.android.intent.NOTIFICATION_INSTALL_CLICKED";
	    	
	    	public static final String EXTRA_NOTIFICATION_ACTION = "cn.sin.android.NOTIFICATION_ACTION";
	    	public static final String EXTRA_NOTIFICATION_CATEGORY = "cn.sin.android.NOTIFICATION_CATEGORY";
	    	public static final String EXTRA_NOTIFICATION_PENDINTENT_TYPE = "cn.sin.android.NOTIFICATION_PENDINTENT_TYPE";
	    	
	    	public static final String SYSTEM_FULLSCREEN_ACTION = "cn.sin.android.intent.SYSTEM_FULLSCREEN_ACTION";
	    	public static final String SYSTEM_FULLSCREEN_CATEGORY = "cn.sin.android.intent.SYSTEM_FULLSCREEN_CATEGORY";
	    	
	    	public static final String SHOW_FLOAT_VIEW_ACTION = "cn.sin.android.intent.SHOW_FLOAT_VIEW_ACTION";
	    }
}
