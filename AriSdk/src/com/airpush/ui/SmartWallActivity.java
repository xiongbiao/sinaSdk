...
public class SmartWallActivity extends Activity {
    ...
    private String TAG = LogUtil.makeLogTag(SmartWallActivity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if ((this.adType != null) && (this.adType.equalsIgnoreCase("AW"))) {
				...
				requestWindowFeature(1);
				LogUtil.i(TAG, "Dialog Ad called: ");
				setTheme(16973839);
				new DialogAd(intent, SmartWallActivity.this);
			} else if ((this.adType != null)
					&& (this.adType.equalsIgnoreCase("FP"))) {
				LogUtil.i(TAG, "Landing page called: ");
				requestWindowFeature(1);
	...
	private void LandingPageAd() {
		try {
			...
			LinearLayout.LayoutParams borderLayoutParams = new LinearLayout.LayoutParams(
					-1, (int) density * 7);
			...
			RelativeLayout.LayoutParams txtLayoutParams = new RelativeLayout.LayoutParams(
					-2, -2);
			...
			button.setText("X");
			button.setPadding(0, (int) density * 2, (int) density * 10,
					(int) density * 2);
			...
			this.mWebView.loadUrl(MsgInfo.WebShow.getLandingPageAdUrl());
			...
			LogUtil.e(TAG,
					"An error occured while starting LandingPageAd.");
			finish();
		}
	}
	...
	private class AirpushWebClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			...
			try {
				LogUtil.i(TAG, "SmartWall Url: " + url);
