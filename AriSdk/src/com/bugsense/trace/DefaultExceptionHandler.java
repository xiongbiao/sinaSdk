  ...
  implements Thread.UncaughtExceptionHandler
{
  ...
  public void uncaughtException(Thread paramThread, Throwable paramThrowable)
  {
    ...
    {
    	LogUtil.e(G.TAG, "Error sending exception stacktrace", paramThrowable);
      try
      {
        Random localRandom = new Random();
        int j = localRandom.nextInt(99999);
        String str = G.APP_VERSION + "-" + Integer.toString(j);
        LogUtil.d(G.TAG, "Writing unhandled exception to: " + G.FILES_PATH + "/" + str + ".stacktrace");
      ...
      {
    	  LogUtil.e(G.TAG, "Error saving exception stacktrace", paramThrowable);
      }
    }
