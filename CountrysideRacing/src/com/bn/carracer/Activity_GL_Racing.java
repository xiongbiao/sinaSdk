...
import static com.bn.carracer.Constant.BREAKING;
...
import static com.bn.carracer.Constant.ENTER_MENU;
import static com.bn.carracer.Constant.ENTER_SET_VIEW;
import static com.bn.carracer.Constant.ENTER_SOUND;
import static com.bn.carracer.Constant.HISTORY;
import static com.bn.carracer.Constant.LOADING;
import static com.bn.carracer.Constant.OVER;
import static com.bn.carracer.Constant.START_GAME;
import static com.bn.carracer.Constant.START_VIEW;
import static com.bn.carracer.Constant.STRIVE;
import static com.bn.carracer.Constant.screenRatio800x480;
import static com.bn.carracer.Constant.screenRatio854x480;
...
public class Activity_GL_Racing extends Activity {
	...
	private SensorListener mySensorListener = new SensorListener() {
		...
		public void onSensorChanged(int sensor, float[] values) {// 若使用传感器标志位为true,并且场景可触控标志位为true,可使用传感器。
			if (sensor == SensorManager.SENSOR_ORIENTATION
					&& sensorFlag == true && inGame == true) {// 判断是否为加速度传感器变化产生的数据
				int[] directionDotXY = RotateUtil.getDirectionDot(new double[] {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		number[0] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.zero);// 加载图片
		number[1] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.one);// 加载图片
		number[2] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.two);// 加载图片
		number[3] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.three);// 加载图片
		number[4] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.four);// 加载图片
		number[5] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.five);// 加载图片
		number[6] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.six);// 加载图片
		number[7] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.seven);// 加载图片
		number[8] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.eight);// 加载图片
		number[9] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.nine);// 加载图片
		number[10] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.colon);// 加载图片
		number[11] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.line);// 加载图片

		shu[0] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.shu0);// 数字纹理
		shu[1] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.shu1);//
		shu[2] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.shu2);//
		shu[3] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.shu3);//
		shu[4] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.shu4);//
		shu[5] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.shu5);//
		shu[6] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.shu6);//
		shu[7] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.shu7);//
		shu[8] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.shu8);//
		shu[9] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.shu9);//
		shu[10] = BitmapFactory.decodeResource(this.getResources(),
				R.drawable.baifenhao);//
