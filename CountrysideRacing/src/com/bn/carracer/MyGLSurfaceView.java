	...
	{
        {
            ...
            loadProcessGo(18);
        	lovn_car_wd=LoadUtil.loadFromFileVertexOnly("tailight.obj", Activity_GL_Racing.rs);//加载车尾灯
        	loadProcessGo(10);
        	lovn_car_lt=
        		LoadUtil.loadFromFileVertexOnly("tire.obj", Activity_GL_Racing.rs);//加载轮胎
        	loadProcessGo(10);
        	lovn_speed_spring = LoadUtil.loadFromFileVertexOnly("spring.obj", Activity_GL_Racing.rs);//加载速度弹簧
        	loadProcessGo(12);
