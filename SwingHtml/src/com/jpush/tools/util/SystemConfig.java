...
public class SystemConfig {
	...
	/*
	 * Static block run once at class loading We load the default properties and
	 * any custom properties we find
	 */
	static {
		...
		try {
			...
			Class configClass = Class.forName("com.jpush.tools.util.SystemConfig");
				...
				for (int i = 0; i < expandedProperties.length; i++) {
					...
					if (initialValue != null) {
						...
						if (log.isDebugEnabled()) {
							log.info("Expanded value of " + propName
